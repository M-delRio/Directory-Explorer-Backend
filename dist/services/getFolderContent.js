...
const getFolderContent = relativeQueryPath => {
  ...
  folderData.files = folderData.files.sort(fileSizeCompare); // sort subfolders alphabetically

  folderData.subFolders = folderData.subFolders.sort(fileSizeCompare); // folderData.subFolders.sort(fileSizeCompare);

  return folderData;
};

module.exports = getFolderContent; // export default getFolderContent;